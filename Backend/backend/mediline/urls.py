...
from .views import FilesViewSet, DocViewSet, AppointmentViewSet, ClinicViewSet, SpecializationViewSet, DocspecViewSet, AvailabilityViewSet, ClinicappointmentsViewSet, DoctorsappointmentsViewSet
