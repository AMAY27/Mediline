      ...
      return (
        <div className='fixed inset-0 flex justify-center items-center bg-black bg-opacity-50'>
          <div className='flex items-center grid grid-cols-1 bg-white border-2 border-green-300 rounded-lg w-56 h-56'>
            ...
            <button className="mx-2 my-1 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">User</button>
